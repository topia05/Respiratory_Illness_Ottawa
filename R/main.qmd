...
1.  **Dataset A: Emergency department visits**

    Columns are:

    -   `Epidemiological_Week`
    -   `Age_Category`
    -   `All_Causes_ED_Visits_to_Ottawa_Hospitals`
...
2.  **Dataset B: Respiratory Outbreaks (Excluding COVID)**

    Columns are:

    -   `Week_Number`
    -   `Start_of_the_Week`
    -   `Number_of_Respiratory_Outbreaks`
    -   Historical baselines (previous 3-season average, pre-COVID average)
